  ...
  >
        ...
        <tr style="vertical-align: top">
          ...
          >
            ...
            <div
              ...
              style="padding: 0px; background-color: #26264f"
            >
              <div
                class="u-row"
                style="
                          ...
                          <tbody>
                            <tr>
                              ...
                              >
                                ...
                                >
                                  <span
                                    ><strong>Product Delivery <br /></strong
                                  ></span>
                                </h1>
    ...
    <![endif]-->
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
        <tr>
          <td background="https://cdn.templates.unlayer.com/assets/1637606548362-white-concrete-wall.jpg" valign="top" width="100%">
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
        <v:fill type="frame" src="https://cdn.templates.unlayer.com/assets/1637606548362-white-concrete-wall.jpg" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 140%">
                                    <span
                                      ...
                                      "
                                      >Order Number: {{$mail_data['order_id']}}</span
                                    >
                                  </p>
                                </div>
                              </td>
