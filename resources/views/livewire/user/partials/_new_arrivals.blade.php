                        ...
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                ...
                                <div class="product-cart-items">
                                    <a href="javascript:;" wire:click="addToWishList({{$product->id}})" class="favourite cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="javascript:;" wire:click="productDetails({{ $product->id }},'{{$product->slug}}','{{$product->category_id}}')" class="product-details">{{ $product->name }}</a>
                                    <div class="price">
