...
{
    public $phone_number, $address, $web_name, $email, $iframe_map_link, $delivery_policy, $refund_policy;
    public function mount()
    {
        ...
        if ($setting) {
            ...
            $this->refund_policy = $setting->refund_policy;
        }
    }
    public function save_settings()
    {
        ...
        if ($setting) {
            ...
            $setting->refund_policy = $this->refund_policy;
            if($setting->save()){
